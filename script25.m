...
giveupdistance = -100; %when 10 meters behind your 'victim' cyclist, then give up and return to our origional lane
...
while i < race_length
    ...
    for player = 1:num_players
        ...
        if ~isempty(riders(player).overtakingvictimID) %this means the cyclist is currently overtaking someone else
            ...
            elseif relative_pos_matrix(player,riders(player).overtakingvictimID)<giveupdistance
