...
dt =0.2; %seconds per time step - MUST BE GREATER THAN ~0.05 (i.e. a function of minimum velocity) otherwise at each time step, the rider would be rounded to the nearest discrete space and appear to be travelling round the velodrome even at '1m/s'
num_players =4;
