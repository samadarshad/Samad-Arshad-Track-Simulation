%script for screenshots for poster 
...
riders(1).position(1,:) = [-25 50 0];%[0 -50 0];
...
riders(1).lane =3*ones(1,race_length);%[14*ones(1,time_of_attack) lane_ramp 2*ones(1,race_length-size(lane_ramp,1)-time_of_attack)];%[lane_ramp 2*ones(1,race_length-size(lane_ramp,1))];  %[4 4 2*ones(1,race_length-2)];%[lane_ramp 2*ones(1,race_length-size(lane_ramp,1))];%2*ones(1,race_length);%[4 4 2*ones(1,race_length-2)];%[lane_ramp 2*ones(1,race_length-size(lane_ramp,1))];%[4 2*ones(1,race_length-1)]; %kinetic energy from 4th lane applied to rider
...
riders(2).lane = 3*ones(1,race_length);%[14*ones(1,time_of_attack+opponent_delay) lane_ramp 2*ones(1,race_length-size(lane_ramp,1)-time_of_attack-opponent_delay)];
